...
15. **[Cost-based Query Optimization]((https://issues.apache.org/jira/browse/PHOENIX-1177))**. Drive query optimizations based on statistics over the data.
    * **[Collect and maintains stats](https://issues.apache.org/jira/browse/PHOENIX-180)** to improve the parallelization during query execution.
