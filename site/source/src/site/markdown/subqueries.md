...
Here, _collect\_distinct()_ is a reserved internal function in Phoenix, which essentially collects all different values of a certain column or expression into a Phoenix Array.
