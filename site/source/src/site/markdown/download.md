...
Current release 4.14.2 can run on Apache HBase 1.3 and 1.4.  CDH HBase 5.11, 5.12, 5.13 and 5.14 is supported by 4.14.0. Apache HBase 2.0 is supported by 5.0.0. Please follow the appropriate link depending on your HBase version. 
...
addRelease('4.14.2-HBase-1.4','28/may/2019');
addRelease('4.14.2-HBase-1.3','28/may/2019');
