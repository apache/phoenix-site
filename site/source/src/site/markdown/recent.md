...
2. **[Asynchronous Initial Population.](secondary_indexing.html#MR_Index_Build)**. Enables an index to be created asynchronously using a map reduce job **Available in our 4.4 release**
