...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Page Not Found | Apache Phoenix" },
    {
      name: "description",
      content:
        "The page you are looking for does not exist. The website was updated recently, so the route you were trying to visit might have changed."
    },
