...
_Pre-requisite:_ [Download](/downloads) and [install](/docs/installation) the latest Phoenix.
...
- Use **Salting** to increase read/write performance  
  ...
  _Note: Ideally for a 16 region server cluster with quad-core CPUs, choose salt buckets between 32-64 for optimal performance._
...
- **Optimize cluster** parameters
  See https://hbase.apache.org/docs/performance
