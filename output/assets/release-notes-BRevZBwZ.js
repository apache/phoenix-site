...
`,e.jsx(i.p,{children:e.jsx(i.strong,{children:"Future releases of Phoenix may require that affected tables be upgraded prior to moving to the new release."})})]})}function r(s={}){const{wrapper:i}=s.components||{};return i?e.jsx(i,{...s,children:e.jsx(n,{...s})}):n(s)}function l(){return e.jsx(h,{Content:r,className:"mt-12"})}function y({}){return[{title:"Release Notes - Apache Phoenix"},{name:"description",content:"Release notes and upgrade considerations for Apache Phoenix releases."}]}const f=a(function(){return e.jsx(l,{})});export{f as default,y as meta};
