import{j as e}from"./jsx-runtime-CUISpl0r.js";let a=`A Phoenix [view](/docs/features/views) is a logical table that shares a single physical
...
[Strict vs Relaxed TTL](/docs/features/ttl#strict-vs-relaxed-ttl) applies to view
TTL too.
`,h={title:"View TTL",description:"Per-view retention on top of a shared base table — different views can age data out on different schedules without splitting the table."},l=[{href:"/docs/features/views"},{href:"https://issues.apache.org/jira/browse/PHOENIX-6978"},{href:"/docs/features/conditional-ttl"},{href:"/docs/features/conditional-ttl"},{href:"/docs/features/ttl#strict-vs-relaxed-ttl"}],r={contents:[{heading:void 0,content:`A Phoenix view is a logical table that shares a single physical
HBase table with its sibling views. **View TTL** lets each view define its **own** data
retention policy on top of that shared table. Rows that have outlived their view's TTL
disappear from queries against that view and are eventually removed in the background —
without affecting any other view (or the base table). Available in Phoenix 5.3.0
...
`,e.jsx(i.code,{children:"'CLOSED'"})]}),"). The ",e.jsx(i.code,{children:"IS_STRICT_TTL"}),` property described in
`,e.jsx(i.a,{href:"/docs/features/ttl#strict-vs-relaxed-ttl",children:"Strict vs Relaxed TTL"}),` applies to view
TTL too.`]})]})}function o(n={}){const{wrapper:i}=n.components||{};return i?e.jsx(i,{...n,children:e.jsx(t,{...n})}):t(n)}export{a as _markdown,o as default,l as extractedReferences,h as frontmatter,r as structuredData,d as toc};
