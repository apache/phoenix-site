import{j as e}from"./chunk-EPOLDU6W-B5LwAila.js";import{D as l,B as c}from"./download-BF9HroEg.js";import{C as d}from"./code-xml-BwZ6kwnw.js";import"./createLucideIcon-BidaCVke.js";let g=`import { Bug, Code2, Download } from "lucide-react";
...
`,e.jsxs(n.p,{children:["Non-transactional tables have no guarantees beyond HBase row-level atomicity (see ",e.jsx(n.a,{href:"https://hbase.apache.org/acid-semantics.html",children:"HBase ACID semantics"}),"). Also, non-transactional tables do not see updates until commit occurs."]}),`
...
`,e.jsxs(n.p,{children:["Phoenix supports mapping to an existing HBase table through ",e.jsx(n.a,{href:"/docs/grammar#create-table",children:e.jsx(n.code,{children:"CREATE TABLE"})})," and ",e.jsx(n.a,{href:"/docs/grammar#create-view",children:e.jsx(n.code,{children:"CREATE VIEW"})}),". In both cases, HBase metadata remains as-is, except that with ",e.jsx(n.code,{children:"CREATE TABLE"}),", ",e.jsx(n.a,{href:"http://hbase.apache.org/book/cf.keep.deleted.html",children:"KEEP_DELETED_CELLS"})," is enabled so flashback queries work correctly."]}),`
