import{j as e}from"./chunk-EPOLDU6W-B5LwAila.js";let i=`**Phoenix-DynamoDB** is a REST service that lets applications written against the
...
For native Phoenix workloads, prefer the standard JDBC driver or the
[Phoenix Query Server](/docs/features/query-server) — they expose the full SQL
surface, not just whatever subset the DynamoDB API maps onto.
...
protocol most clients already know how to talk to.`}),`
`]}),`
`,e.jsxs(n.p,{children:[`For native Phoenix workloads, prefer the standard JDBC driver or the
`,e.jsx(n.a,{href:"/docs/features/query-server",children:"Phoenix Query Server"}),` — they expose the full SQL
surface, not just whatever subset the DynamoDB API maps onto.`]}),`
...
`]})]})}function c(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{i as _markdown,c as default,r as extractedReferences,h as frontmatter,s as structuredData,d as toc};
