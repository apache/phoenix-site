import{j as e}from"./chunk-EPOLDU6W-B5LwAila.js";let a=`\`PHOENIX_ROW_TIMESTAMP()\` is a built-in SQL function that returns the **timestamp
...
returns the value of the `,e.jsx(i.code,{children:"ROW_TIMESTAMP"})," column for that row."]})]})}function o(n={}){const{wrapper:i}=n.components||{};return i?e.jsx(i,{...n,children:e.jsx(s,{...n})}):s(n)}export{a as _markdown,o as default,r as extractedReferences,h as frontmatter,l as structuredData,d as toc};
