import{j as i}from"./jsx-runtime-CUISpl0r.js";let r=`The Python driver for Apache Phoenix implements the [Python DB 2.0 API](https://www.python.org/dev/peps/pep-0249/) to access Phoenix via Phoenix Query Server.
