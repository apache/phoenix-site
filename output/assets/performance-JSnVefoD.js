import{j as e}from"./jsx-runtime-CUISpl0r.js";import{_ as s,a as i,b as a,c as h,d as l,e as c,f as d}from"./perf-topn-C8Xi2q9P.js";let f=`
...
<img alt="Phoenix vs Hive" src={__img0} />
...
<img alt="Phoenix vs Impala" src={__img1} />
...
<img alt="Salted-Write" src={__img4} />
...
<img alt="Salted-Read" src={__img5} />
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"Phoenix vs Hive",src:s})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"Phoenix vs Impala",src:i})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"Ess. CF",src:a})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"SkipScan",src:h})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"Salted-Write",src:l})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"Salted-Read",src:c})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.img,{alt:"Phoenix vs Hive",src:d})})]})}function E(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}function m(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{f as _markdown,E as default,x as extractedReferences,g as frontmatter,T as structuredData,w as toc};
