import{j as e}from"./jsx-runtime-CUISpl0r.js";let l=`Phoenix surfaces various metrics that provide an insight into what is going on within the Phoenix client as it is executing various SQL statements. These metrics are collected within the client JVM in two ways:
...
seen while executing the query, as a list of JSON-object lists — one outer
entry per slow scan path, one inner entry per HBase table touched on that
path. Forward to your telemetry sink as needed.`}],headings:[{id:"request-level-metrics",content:"Request-level metrics"},{id:"mutation-metrics",content:"Mutation metrics"},{id:"scan-task-metrics",content:"Scan task metrics"},{id:"overall-query-metrics",content:"Overall query metrics"},{id:"how-to-use-sql-statement-level-metrics",content:"How to use SQL statement-level metrics"},{id:"scan-latency-metrics",content:"Scan latency metrics"},{id:"top-n-slowest-scans",content:"Top-N slowest parallel scans"},{id:"enabling",content:"Enabling"},{id:"retrieving-the-result",content:"Retrieving the result"}]},c=[{depth:2,url:"#request-level-metrics",title:e.jsx(e.Fragment,{children:"Request-level metrics"})},{depth:3,url:"#mutation-metrics",title:e.jsx(e.Fragment,{children:"Mutation metrics"})},{depth:3,url:"#scan-task-metrics",title:e.jsx(e.Fragment,{children:"Scan task metrics"})},{depth:3,url:"#overall-query-metrics",title:e.jsx(e.Fragment,{children:"Overall query metrics"})},{depth:2,url:"#how-to-use-sql-statement-level-metrics",title:e.jsx(e.Fragment,{children:"How to use SQL statement-level metrics"})},{depth:2,url:"#scan-latency-metrics",title:e.jsx(e.Fragment,{children:"Scan latency metrics"})},{depth:2,url:"#top-n-slowest-scans",title:e.jsx(e.Fragment,{children:"Top-N slowest parallel scans"})},{depth:3,url:"#enabling",title:e.jsx(e.Fragment,{children:"Enabling"})},{depth:3,url:"#retrieving-the-result",title:e.jsx(e.Fragment,{children:"Retrieving the result"})}];function n(s){const i={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.p,{children:"Phoenix surfaces various metrics that provide an insight into what is going on within the Phoenix client as it is executing various SQL statements. These metrics are collected within the client JVM in two ways:"}),`
