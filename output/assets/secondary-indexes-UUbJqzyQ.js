...
`,e.jsxs(n.li,{children:["Though the actual number of threads is dictated by the Max(number of call queues, handler count), where the number of call queues is determined by standard HBase configuration. To further tune the queues, you can adjust the standard rpc queue length parameters (currently, there are no special knobs for the index queues), specifically ",e.jsx(n.code,{children:"ipc.server.max.callqueue.length"})," and ",e.jsx(n.code,{children:"ipc.server.callqueue.handler.factor"}),". See the ",e.jsx(n.a,{href:"http://hbase.apache.org/book.html",children:"HBase Reference Guide"})," for more details."]}),`
...
`]})]})}function h(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{s as _markdown,h as default,o as extractedReferences,r as frontmatter,l as structuredData,d as toc};
