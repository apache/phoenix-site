import{j as e}from"./chunk-EPOLDU6W-B5LwAila.js";let a=`The \`UPDATE STATISTICS\` command updates the statistics collected on a table.
...
on the data should be used to drive query parallelization.`},{heading:"statistics-collection-configuration",content:"The default value is true."}],headings:[{id:"statistics-collection-parallelization",content:"Parallelization"},{id:"statistics-collection-examples",content:"Examples"},{id:"known-issues",content:"Known issues"},{id:"statistics-collection-configuration",content:"Configuration"}]};const h=[{depth:2,url:"#statistics-collection-parallelization",title:e.jsx(e.Fragment,{children:"Parallelization"})},{depth:2,url:"#statistics-collection-examples",title:e.jsx(e.Fragment,{children:"Examples"})},{depth:2,url:"#known-issues",title:e.jsx(e.Fragment,{children:"Known issues"})},{depth:2,url:"#statistics-collection-configuration",title:e.jsx(e.Fragment,{children:"Configuration"})}];function s(i){const t={a:"a",code:"code",em:"em",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(t.p,{children:["The ",e.jsx(t.code,{children:"UPDATE STATISTICS"}),` command updates the statistics collected on a table.
This command collects a set of keys per region per column family that
