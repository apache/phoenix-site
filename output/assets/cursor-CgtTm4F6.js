import{j as s}from"./jsx-runtime-CUISpl0r.js";let h=`To work on a subset of rows from a query, Phoenix supports a \`CURSOR\` control structure. The sequence below shows how to use a cursor.
